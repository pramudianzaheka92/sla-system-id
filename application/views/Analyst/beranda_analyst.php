...
<div class="content-wrapper">
	...
	<section class="content-header">
		<div class="container-fluid">
			<div class="row mb-2">
				<div class="col-sm-6">
					<h1>Beranda Analyst</h1>
				</div>
				<div class="col-sm-6">
					<ol class="breadcrumb float-sm-right">
						<li class="breadcrumb-item"><a href="<?php echo site_url('#')?>">Beranda Analyst</a></li>
						<li class="breadcrumb-item active">Beranda Analyst</li>
					</ol>
				</div>
			</div>
		</div><!-- /.container-fluid -->
				...
				<div class="col-12">
					<div class="card">
						<div class="card-header">
							<h3 class="card-title">Beranda Analyst</h3>
								...
								<tbody>
									...
									<tr>
										...
										<td style="display:flex">
											...
											<form action="<?php echo base_url('BerandaAnalyst/detail');?>" method="get">
		...
		<div class="container-fluid">
			...
			<div class="row">
				<div class="col-12">
					<div class="card">
						<div class="card-header">
							<h3 class="card-title">Feedback Bisnis</h3>
							<div class="card-tools">
							</div>
						</div>
								...
								<tbody>
									...
									<tr>
										...
										<td style="display:flex">
											...
											<form action="<?php echo base_url('BerandaAnalyst/detail2');?>" method="get">
												<input type="hidden" value="<?php echo $row->id_history;?>"
													name="id_history">
												<input type="hidden" value="<?php echo $row->id_document;?>"
													name="id_document">
